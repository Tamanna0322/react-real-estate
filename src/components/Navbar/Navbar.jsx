            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-2 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                        <NavLink to='/' className={({ isActive }) => isActive ? 'text-green-600  font-bold rounded-lg' : 'font-semibold text-black'}>Home</NavLink>
                        <NavLink to='/updateProfile' className={({ isActive }) => isActive ? 'text-green-600  font-bold rounded-lg ' : 'font-semibold text-black'}>Update Profile</NavLink>
                        <NavLink to='/userProfile' className={({ isActive }) => isActive ? 'text-green-600  font-bold rounded-lg ' : 'font-semibold text-black'}>User Profile</NavLink>
                    </ul>
                </div>
